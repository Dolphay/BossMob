...
public class RenderModdedParrot extends RenderLiving<EntityModdedParrot>
{
    ...
    public RenderModdedParrot(RenderManager p_i47375_1_)
    {
        super(p_i47375_1_, new ModelModdedParrot(), 0.3F);
    }

    /**
     * Returns the location of an entity's texture. Doesn't seem to be called unless you call Render.bindEntityTexture.
     */
    protected ResourceLocation getEntityTexture(EntityModdedParrot entity)
    {
     ...
     */
    public float handleRotationFloat(EntityModdedParrot livingBase, float partialTicks)
    {
        return this.getCustomBob(livingBase, partialTicks);
    }

    private float getCustomBob(EntityModdedParrot parrot, float p_192861_2_)
    {
